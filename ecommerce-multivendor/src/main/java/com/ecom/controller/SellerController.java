...
public class SellerController {
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws Exception, MessagingException {
        ...
        String subject = "Ecom Multivendor Email Verification Code";
        String text = "Welcome to Ecom Multivendor, Verify your account using this link";
        String frontend_url = "http://localhost:3300/verify-seller/";
